...
image:
feature:
date: 2021-11-01T23:16:00-04:00
modified: 2016-06-01T14:19:19-04:00
---

# mybatis 서버 재시작 없이 xml수정
RefreshableSqlSessionFactoryBean.java 추가

sqlSessionFactory인 bean의 class를 RefreshableSqlSessionFactoryBean.java로 교체
...
## root-context.xml 또는 sqlSessionFactory bean설정파일
```
<!-- <bean id="sqlSessionFactory" class="org.mybatis.spring.SqlSessionFactoryBean"> -->
<bean id="sqlSessionFactory" class="package.RefreshableSqlSessionFactoryBean">
